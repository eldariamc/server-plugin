Server-Plugin
=============
Rassemble toutes les modification du gameplay apportées via l'API Bukkit/Spigot

Modifications apportées
-----------------------
- Ajout des commandes pour gérer les bossbar, actionbar et announce
- Système de KS
- Gestoin des minerais LuckyOre et XpOre
- TP sur la map lorsqu'un joueur tombe dans le vide
- Système d'orbe de réparation
- Système d'effet constant dans certaines conditions
- ...
